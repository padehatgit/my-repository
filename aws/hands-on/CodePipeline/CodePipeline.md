...
- to clone your repository from AWS CodeCommit consol 

- click on newly created repo

-  copy the code like "git clone https://git-codecommit.us-east-1.amazonaws.com/v1/repos/my-angular-project"
...
```
- Since you dont have any permisioon , system expect you to enter your CodeCommit username and password created like GitHub
...
git push
```
- then check the pipeline and it will deploy new version of the project . Check it from browser
